...
export const COLOR_PALETTES: Record<Exclude<ColorPalette, 'custom'>, PaletteDefinition> = {
  'hubspot-orange': {
    name: 'HubSpot Orange',
    colors: ['#FF7A59', '#FF8F73', '#FFA38C', '#FFB8A6', '#FFCDBF', '#FFE2D8', '#FFF1EC', '#FFF8F5'],
    preview: ['#FF7A59', '#FF8F73', '#FFA38C', '#FFB8A6', '#FFCDBF'],
  },
  professional: {
    name: 'Professional',
    colors: ['#0091AE', '#1AA0BA', '#33A1B8', '#4DB2C6', '#66B2C2', '#80C2CE', '#99C2CC', '#B3D2D9'],
    preview: ['#0091AE', '#33A1B8', '#66B2C2', '#99C2CC', '#B3D2D9'],
  },
  vibrant: {
    name: 'Vibrant',
    colors: ['#FF7A59', '#F2547D', '#E03E9E', '#C95DD8', '#9B7FF5', '#7C98F5', '#00BFB3', '#00B3A4'],
    preview: ['#FF7A59', '#F2547D', '#C95DD8', '#7C98F5', '#00B3A4'],
  },
  cool: {
    name: 'Cool',
    colors: ['#0091AE', '#33A1B8', '#5DBCD2', '#7CC8DE', '#99D6E8', '#B3E0EE', '#CCE9F4', '#E6F4FA'],
    preview: ['#0091AE', '#33A1B8', '#5DBCD2', '#7CC8DE', '#99D6E8'],
  },
  warm: {
    name: 'Warm',
    colors: ['#FF7A59', '#FF9270', '#FFAA87', '#FFC29E', '#FFD9B5', '#FFE7CC', '#FFF3E3', '#FFF9F0'],
    preview: ['#FF7A59', '#FF9270', '#FFAA87', '#FFC29E', '#FFD9B5'],
  },
  green: {
    name: 'Green',
    colors: ['#00A86B', '#26B580', '#33BA8A', '#59C79F', '#66CBA9', '#8CD9BD', '#99DDC8', '#B3E7D6'],
    preview: ['#00A86B', '#33BA8A', '#66CBA9', '#99DDC8', '#B3E7D6'],
  },
  purple: {
    name: 'Purple',
    colors: ['#7C98F5', '#8DA5F7', '#96ACF7', '#A7B9F9', '#B0C0F9', '#C1CEFB', '#CAD4FB', '#DBE2FD'],
    preview: ['#7C98F5', '#96ACF7', '#B0C0F9', '#CAD4FB', '#DBE2FD'],
  },
  monochrome: {
    name: 'Monochrome',
    colors: ['#2D3E50', '#425568', '#516F90', '#6586A8', '#7594B0', '#8AA8C8', '#99B9D0', '#ADC9E8'],
