...
import type { BaseAlertInput, NormalizedAlertInput, AlertRowColumns, KpiAlert } from '../../../types/kpi_alert';
 ...
 * Used by both kpiScheduleResolvers and kpiThresholdResolvers.
 */
